...
from data_fetching.utils import write_df_to_s3, read_df_from_s3, print_alerts, get_alerts
...
with DAG(
    ...
    def get_weather_alerts_task():
        locations = read_df_from_s3(filename="locations.csv")
    ...
    def print_alerts_task():
        weather_alerts = read_df_from_s3(filename="weather_alerts.csv")
        air_alerts = read_df_from_s3(filename="air_alerts.csv")
